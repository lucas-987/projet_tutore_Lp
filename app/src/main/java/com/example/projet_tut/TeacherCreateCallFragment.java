...
public class TeacherCreateCallFragment extends Fragment {
    ...
    private View.OnClickListener validateButtonClicked = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Navigation.findNavController(getView()).navigate(R.id.action_teacherCreateCall_to_teacherCallFragment);
        }
    };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_teacher_create_call, container, false);

        disciplineSpinner = v.findViewById(R.id.teacherCreateCall_discipline_spinner);
        groupSpinner = v.findViewById(R.id.teacherCreateCall_group_spinner);

        validateButton = v.findViewById(R.id.teacherCreateCall_validate_button);
